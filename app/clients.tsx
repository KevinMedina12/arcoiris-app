...
export default function StoragePage() {
  ...
  useEffect(() => {
    const unsubscribe = firebase.firestore().collection('Clientes').onSnapshot((snapshot: QuerySnapshot) => {
  ...
  const addClient = async () => {
    try {
      ...
      const docRef = await firebase.firestore().collection('Clientes').add({ ...newClient, key: newId });
